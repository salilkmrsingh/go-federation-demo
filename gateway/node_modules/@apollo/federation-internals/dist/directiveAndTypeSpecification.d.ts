...
import { CoreFeature, InputType, NamedType, OutputType, Schema } from "./definitions";
...
export declare function ensureSameTypeKind(expected: NamedType['kind'], actual: NamedType): GraphQLError[];
