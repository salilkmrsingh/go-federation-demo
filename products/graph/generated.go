...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateProduct func(childComplexity int, name string, price float64) int
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createProduct":
		...
		return e.complexity.Mutation.CreateProduct(childComplexity, args["name"].(string), args["price"].(float64)), true
...
func (ec *executionContext) field_Mutation_updateProduct_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["id"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNUpdateProduct2productsᚋgraphᚋmodelᚐUpdateProduct)
	if err != nil {
		return nil, err
	}
	args["input"] = arg1
...
func (ec *executionContext) _Entity_findProductByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNProduct2ᚖproductsᚋgraphᚋmodelᚐProduct,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_createProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Mutation().CreateProduct(ctx, fc.Args["name"].(string), fc.Args["price"].(float64))
		},
		nil,
		ec.marshalNProduct2ᚖproductsᚋgraphᚋmodelᚐProduct,
		true,
...
func (ec *executionContext) _Mutation_deleteProduct(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOProduct2ᚖproductsᚋgraphᚋmodelᚐProduct,
		true,
		false,
	)
}
...
func (ec *executionContext) _Query_products(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNProduct2ᚕᚖproductsᚋgraphᚋmodelᚐProductᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) marshalNProduct2productsᚋgraphᚋmodelᚐProduct(ctx context.Context, sel ast.SelectionSet, v model.Product) graphql.Marshaler {
...
func (ec *executionContext) unmarshalNUpdateProduct2productsᚋgraphᚋmodelᚐUpdateProduct(ctx context.Context, v any) (model.UpdateProduct, error) {
